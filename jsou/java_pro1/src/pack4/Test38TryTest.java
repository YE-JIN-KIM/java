...
//        - 일반 명령문 작업 시 에 에러가 발생할 의심적인 코드가 있을 때도 선택적으로 사용
//try -catch 문
//예외처리를 위한 try, catch문의 기본 구조이다.
...
public class Test38TryTest {
	...
	public void test() {
		try {
			...
			System.out.println("Test 메소드 에서 에러");
		}
	}

	public static void main(String[] args) {
		//FileReader fr = new FileReader("c:\\work\\abc.txt");  예외처리를 해줘야함
