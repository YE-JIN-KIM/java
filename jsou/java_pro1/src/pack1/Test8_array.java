...
public class Test8_array {
	...
	public static void main(String[] args) {
		// 배열(Array)
		// 성격과 크기가 일치하는 여러 개의 기억장소에 대해 대표명을 하나 부여하고
		...
		System.out.println();
		int[] ar1 = {1,2,3,4,5};
		System.out.println(ar1 + "" +ar[0] +" " + ar1.length);
		System.out.println(ar1[0]+ " " + ar1[1] + " " + ar1[2] + " " + ar1[3] + " " + ar1[4]);
		for(int i =0; i < ar1.length; i++) {
			System.out.print(ar1[i]+ " ");
		}
		System.out.println();
		for(int i:ar1) {     // 향상된 for : 배열, 컬렉에서 사용능
			System.out.print(i + " ");
		}
