...
public class Test11_Programmer {
	...
	public final double PI = 3.14;   //instance 소유 readonly
	public final static double KOR = 99.0;   //class 소유
	
	public Test11_Programmer() {
		System.out.println("난 생성자");
		System.out.println("초기화 할 것이 없을 떄는 적지 않아도 인정");
		nickName = "자바 귀신";
		age = 25;
		//displayData();
	}
